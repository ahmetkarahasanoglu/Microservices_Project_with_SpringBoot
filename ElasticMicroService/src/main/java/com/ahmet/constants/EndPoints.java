...
public class EndPoints {
    /**
     * Uygulamanız içinde kullanılan tüm erişim noktalarının listesi
     * burada tutulur, böylece farklı ortamlar için kullanılacak
     * end pointler tek bir noktadan değiştirilebilir.
     */
